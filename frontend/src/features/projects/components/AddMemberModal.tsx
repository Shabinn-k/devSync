...
export const AddMemberModal = ({ projectId, onClose, onSuccess }: AddMemberModalProps) => {
    const [email, setEmail] = useState('');
    const [role, setRole] = useState<ProjectRole>('member');
    const [localError, setLocalError] = useState<string | null>(null);
    const { addMember, isSaving, error, clearError } = useProjectStore();
        ...
        >
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                    ...
                    <h2 className="text-sm font-medium text-white">Add Project Member</h2>
                </div>
                <button
                    onClick={onClose}
