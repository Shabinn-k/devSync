...
export const Mascot = () => {
  ...
  return (
    ...
    >
      ...
      {/* Character 1 — large tilted rectangle, -6deg rotation */}
      ...
      {/* Character 4 — large semicircle at the front, happy face */}
      <g>
